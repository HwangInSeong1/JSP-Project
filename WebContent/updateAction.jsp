...
<body>
	<%
	    ...
	    if(!user_ID.equals(mvr.getUser_ID())){
			...
			if(request.getParameter("r_Title") == null || request.getParameter("r_Content") == null
					|| request.getParameter("r_Title").equals("") || request.getParameter("r_Content").equals("") ) {
				PrintWriter script =response.getWriter();
				script.println("<script>");
				...
				int result = mvrDAO.update(R_NUM,request.getParameter("r_Title"),request.getParameter("r_Content"));
				if(result == -1) {
					PrintWriter script =response.getWriter();
					script.println("<script>");
