    ...
    <body>
        ...
        <th colspan=2 style="border:0px solid white;"> <a href="write.jsp" target=if1><input type=button value="작성하기"></a></th>
            ...
            <%
            	...
            	ArrayList<Mvr> list01 = mvrDAO.getList01();
            	for(int i = 0; i < list01.size(); i++) {
            %>
            <tr>
                <th><%= list01.get(i).getR_NUM() %></th> 
                <th><a href="view.jsp?R_NUM=<%= list01.get(i).getR_NUM() %>"><%= list01.get(i).getR_Title() %></a></th> 
                <th><%= list01.get(i).getUser_ID() %></th> 
                <th><%= list01.get(i).getR_DATE().substring(0, 11) + list01.get(i).getR_DATE().substring(11, 13) + "시" + list01.get(i).getR_DATE().substring(14, 16) + "분" %></th>
            </tr>
			<%
            	}
            %>
