<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <body>
        <div id=id>
            <br>
            <a href="index.jsp" target=_self><img src="img/main.jpg" width=300 height=200></a>
            <br>
            <p style="font-size:25px;font-weight: bold;font-family: 고딕;">Welcome to Movie Review Club!</p>
            
        <form method="POST" action="signAction.jsp" id="formsign">
        <table>
            <tr>
                <td style="width:130px;background-color:black;color:white;"><b>&nbsp;ID</b></td> 
                <td style="background-color:black;color:white"><input type=text size=62 name=user_ID placeholder="아이디 입력" required></td>
            </tr>
            <tr>
                <td style="width:130px;background-color:black;color:white"><b>&nbsp;PW</b></td> 
                <td style="background-color:black;color:white"><input type=password size=62 id=pw1 name=user_PW placeholder="비밀번호 입력" required></td>
            </tr>
            <tr>
                <td style="width:130px;background-color:black;color:white"><b>&nbsp;Re:PW</b></td> 
                <td style="background-color:black;color:white"><input type=password size=62 id=pw2 name=user_PW2 placeholder="비밀번호 재입력"></td>
            </tr>
             <tr>
                <td style="width:130px;background-color:black;color:white"><b>&nbsp;Name</b></td> 
                <td style="background-color:black;color:white"><input type=text size=62 name=user_NAME placeholder="이름 입력"></td>
            </tr>
            <tr>
                <td style="width:130px;background-color:black;color:white"><b>&nbsp;Birth</b></td> 
                <td style="background-color:black;color:white"><input type=text size=62 name=user_BIRTH placeholder="2021-01-01"></td>
            </tr>
            <tr>
                <td style="width:130px;background-color:black;color:white"><b>&nbsp;E-mail</b></td> 
                <td style="background-color:black;color:white"><input type=text size=62 name=user_EMAIL placeholder="예)mrc2022@naver.com"></td>
            </tr>
            <tr>
                <td style="width:130px;background-color:black;color:white"><b>&nbsp;Phone</b></td> 
                <td style="background-color:black;color:white"><input type=text size=62 name=user_PHONE placeholder="000-0000-0000"></td>
            </tr>
            <tr>
                <td style="width:130px;background-color:black;color:white;height:30px;"><b>&nbsp;Gender</b></td>
                <td style="border:3px solid black;"><input type="radio" name=user_GENDER value=남자 checked>남자 <input type="radio" name=user_GENDER value=여자>여자</td>
            </tr>
        </table>
        <br>
        <div class=black>
...
제1조 (목적)
            본 약관은 MOVIE REVIEW CLUB 주식회사(이하 '회사')가 고도 사이트(이하 ‘사이트’)를 통하여 인터넷상에서 제공하는 서비스(이하 ‘서비스’)를 이용하는 고객 (이하 '고객')간의 권리와 의무 및 책임 등 기타 제반사항을 규정함을 목적으로 합니다.
...
부칙 (시행일)
        ...
        <br>
        본 약관에 동의합니다.<input type="checkbox" name=check value=ck required>
        </div>
        <br>
